...
const DoctorsCard = ({ doctor }) => {
  ...
  return (
    <div className="p-3 lg:p-5">
      ...
      <div className="mt-2 lg:mt-4 flex flex-center justify-between">
      ...
      <div className="mt-[18px] lg:mt-5 flex flex-center justify-between">
        <div>
        ...
        <Link
          ...
          className="w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] flex items-center justify-center group hover:bg-primaryColor hover:boder-none "
        >
